  ...
  return <div className="min-h-screen bg-background">
      ...
      <section className="bg-gradient-to-r from-primary/10 to-secondary/10 py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <Button asChild size="lg" variant="cta" className="text-5xl">
            <Link to="/quiz">
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          ...
          <div className="grid gap-8 max-w-6xl mx-auto">
            ...
            return <Card key={lender.id} className={`border-l-4 ${lender.borderColor} bg-gradient-to-r ${lender.bgGradient} hover:shadow-lg transition-shadow`}>
                  <CardHeader>
                  ...
                  <CardContent className="space-y-6">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                      ...
                      {lender.termLength && <div className="bg-background/60 rounded-lg p-3">
                      ...
                      {lender.fundingSpeed && <div className="bg-background/60 rounded-lg p-3">
                      ...
                      {lender.minTimeInBusiness && <div className="bg-background/60 rounded-lg p-3">
                      ...
                      {lender.minRevenue && <div className="bg-background/60 rounded-lg p-3">
                      ...
                      {lender.minCreditScore && <div className="bg-background/60 rounded-lg p-3">
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {lender.products.map((product, index) => <Badge key={index} variant="outline" className="text-xs">
                            {product}
                          </Badge>)}
                      </div>
                    </div>
