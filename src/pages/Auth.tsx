...
const Auth = () => {
  ...
  useEffect(() => {
    if (user && !isPasswordReset) {
      // Redirect authenticated users to their applications
  ...
  const handlePasswordReset = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Clear the password reset state and redirect
        ...
        <div className="max-w-4xl mx-auto">
          <Tabs defaultValue="signin" className="w-full">
            <TabsList className="grid w-full grid-cols-4">
              ...
              <TabsTrigger value="broker">Broker/Lender</TabsTrigger>
            </TabsList>
            ...
            <TabsContent value="signup">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Sign up to track your loan applications and access personalized funding options.
                  </CardDescription>
                </CardHeader>
                <CardContent>
