...
const About = () => {
  ...
  const stats = [{
    ...
    description: "Small businesses across Canada connected with funding"
  }, {
    number: "$250M+",
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-3xl mx-auto font-serif">
              ...
              empowering small businesses across Canada to achieve their growth goals.
            </p>
            <div className="flex items-center justify-center gap-2 text-2xl mb-8">
              <span>🍁</span>
              <span className="text-primary font-semibold">Proudly Canadian, Built for Canadian Businesses</span>
            </div>
          </div>
        </div>
      </section>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-lg text-muted-foreground mb-8 font-serif">
                  ...
                  with lenders who want to help them succeed across Canada.
                </p>
              ...
              <div className="relative">
                <img src={manufacturingOwnerImage} alt="Happy manufacturing business owner" className="w-full h-96 object-cover rounded-lg shadow-[var(--shadow-card)]" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {values.map((value, index) => <Card key={index} className="border-0 shadow-[var(--shadow-card)] hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-4 gap-8">
              {stats.map((stat, index) => <Card key={index} className="text-center border-0 shadow-[var(--shadow-card)] hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
                ...
                <div className="grid lg:grid-cols-2">
                  <div className="p-8 lg:p-12">
                    ...
                    <p className="text-lg text-muted-foreground mb-6 font-serif">
                      ...
                      innovators inspires us every day as we serve businesses across Canada.
                    </p>
                  ...
                  <div className="p-0 flex items-center justify-center">
                    <img src={businessOwnerImage} alt="Canadian business owner" className="w-full h-full object-cover rounded-lg" />
                  </div>
                </div>
              </CardContent>
            </Card>
