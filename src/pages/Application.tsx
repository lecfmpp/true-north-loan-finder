  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const applicationData = {
        ...
        principal_ownership_percentage: parseInt(formData.principal_ownership_percentage) || 0,
        ...
        months_with_bank: parseInt(formData.months_with_bank) || 0,
        average_monthly_deposits: parseInt(formData.average_monthly_deposits) || 0,
        monthly_rent_mortgage: parseInt(formData.monthly_rent_mortgage) || 0,
