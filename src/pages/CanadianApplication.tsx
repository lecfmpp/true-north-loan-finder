  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const applicationData = {
        ...
        annual_gross_sales: parseInt(formData.annual_gross_sales) || 0,
        amount_requested: parseInt(formData.amount_requested) || 0,
        ...
        ownership_percentage: parseInt(formData.ownership_percentage) || 0,
        ssn: formData.ssn,
        dob: formData.dob,
