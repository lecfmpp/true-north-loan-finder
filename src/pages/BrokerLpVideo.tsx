...
const BrokerLpVideo = () => {
  ...
  // Add spyme.ca tracking pixel for broker-lp-video
  useEffect(() => {
    const script = document.createElement('script');
    script.defer = true;
    script.src = 'https://spyme.ca/pixel/3YrvJp3rVFdILZYx';
  ...
  return <div className="min-h-screen bg-background">
      <SEOHead title="Broker Partnership Program Video - True North Business Loan" description="Watch our exclusive video presentation about our broker partnership program and start earning competitive commissions on high-quality business loan referrals." keywords={["broker partnership", "business loan broker", "earn commissions", "broker program", "exclusive leads", "video presentation"]} />
