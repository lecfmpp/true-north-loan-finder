...
import { Plus, Calendar as CalendarIcon, Clock, Users, Trash2, Edit } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold">Available Times Management</h2>
          <p className="text-muted-foreground">
            Manage available call slots and view bookings
          </p>
        </div>
              ...
              {bookings.map((booking) => (
                <TableRow key={booking.id}>
                  ...
                  <TableCell>
                    {booking.time_slot && (
                      <div>
                        <div>{format(parseISO(booking.time_slot.date), 'MMM dd, yyyy')}</div>
