...
const LeadTierAnalytics = () => {
  ...
  const getTierCriteria = (tier: string): string => {
    switch (tier) {
      case 'Exceptional (85+)': return '$100K+ revenue • 700+ credit • 2+ years';
      case 'Qualified (45-84)': return '$25K+ revenue • 600+ credit • 6+ months';
      case 'Potential (0-44)': return '<$10K revenue • <580 credit • <6 months';
  ...
  const fetchAnalytics = async () => {
    try {
      ...
      const actualTotalLeads = filteredLeads.length; // Use actual filtered leads count to match Leads tab
