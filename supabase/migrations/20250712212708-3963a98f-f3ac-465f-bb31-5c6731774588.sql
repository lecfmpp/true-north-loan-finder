-- Phase 3: Content Management System Database Setup
...
-- Remove the old published column as we now use status
...
-- Update the existing public view policy to use status instead of published
