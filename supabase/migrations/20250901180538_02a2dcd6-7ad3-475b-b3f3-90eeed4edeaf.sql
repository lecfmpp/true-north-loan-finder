...
CREATE POLICY IF NOT EXISTS "Superadmin can manage video settings" 
...
CREATE POLICY IF NOT EXISTS "Anyone can view active video settings" 
...
CREATE TRIGGER IF NOT EXISTS update_video_settings_updated_at
