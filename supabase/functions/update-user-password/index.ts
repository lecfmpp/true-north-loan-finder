// Deno Edge Function: update-user-password
// Allows superadmins to update a user's password securely using the service role
...
serve(async (req) => {
  ...
  try {
    ...
    // Use a pure service-role client for the admin update
