...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const { enabled, spreadsheetFormat, autoProcessQueue, webhookUrl, eventToggles, fieldMappings }: UpdateSettingsRequest = await req.json()
    ...
    if (existingSettings) {
      ...
      result = await supabase
        ...
        .update({
          ...
          auto_process_queue: autoProcessQueue,
